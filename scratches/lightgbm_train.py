...
def lgb_factory(argsDict):
    ...
    gbm = lgb.train(params, dtrain, num_boost_round=226, valid_sets=dtest, early_stopping_rounds=10)
...
def lgbbest_train(argsDict):
    ...
    x_predict=loss_glo.x_predict
    y_predict=loss_glo.y_predict
    # params = {
    #     'boosting_type': 'gbdt',
    #     'objective': 'regression',
    #     'metric': {'l1', 'l2'},
    ...
    gbm = lgb.train(params, dtrain, num_boost_round=226, valid_sets=dtest, early_stopping_rounds=10)
    loss=get_tranformer_score(gbm,x_predict,y_predict)
    gbm.save_model('/home/xcha8737/Solar_Forecast/trainning_data/dataclean/dataclean/GBMmodel_test.txt')
    # dtrain.save_binary("/home/xcha8737/Solar_Forecast/trainning_data/dataclean/dataclean/train.bin")
    # dtest.save_binary("/home/xcha8737/Solar_Forecast/trainning_data/dataclean/dataclean/test.bin")
...
best = fmin(lgb_factory, space, algo=algo, max_evals=200, pass_expr_memo_ctrl=None, trials=trials)
time_start=time.time()
...
# pandata.to_csv('/home/xcha8737/Downloads/cap/dataclean/test_timestep_lightgbm.csv')
# plt.figure()
...
# plt.savefig('/home/xcha8737/Solar_Forecast/trainning_data/dataclean/dataclean/lightgbm_result.pdf',format = 'pdf', dpi = 1000, bbox_inches = 'tight')
# plt.show()
