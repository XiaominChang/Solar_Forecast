...
def LSTM_training():
    ...
    model.add(keras.layers.LSTM(100, activation='relu', return_sequences=True, input_shape=(n_steps, 6),dropout=0.4, recurrent_dropout=0.2))
    model.add(keras.layers.BatchNormalization())
    model.add(keras.layers.LSTM(50, activation='relu',dropout=0.4, recurrent_dropout=0.2))
    model.add(keras.layers.BatchNormalization())
